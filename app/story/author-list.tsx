  ...
  return (
    <Fragment>
      ...
      <div className=" overflow-y-auto p-4">
        <div>
          <div className="mx-auto max-w-3xl transform divide-y divide-gray-100 overflow-hidden rounded-xl bg-[2f2f2f] shadow-2xl ring-1 ring-black ring-opacity-5 transition-all">
                            ...
                            <Combobox.Option
                              ...
                              className={({ active }) =>
                                classNames(
                                  ...
                                  active && 'bg-gray-700 text-gray-900'
                                )
                              }
                            >
                              {({ active }) => (
                                <>
                                  ...
                                  <span className="ml-3 flex-auto truncate text-white">{person.name}</span>
                                  {active && (
                                    <ChevronRightIcon
