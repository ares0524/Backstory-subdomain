...

                {
                    ...
                    : <div className="container flex flex-wrap justify-between items-center mx-auto bg-white rounded-md dark:bg-slate-500">
                        <div className="text-center border-dashed border-2 border-slate-200 dark:border-slate-100 rounded-md w-full p-20">
                            ...
                            <p className="text-xl mb-2 uppercase font-bold dark:text-white">No collections</p>
                            <span className="text-m text-slate-400 block mb-10 dark:text-slate-50">Get started by adding a new collection</span>
                            <button className="bg-blue-400 rounded-full px-5 py-3 text-white hover:bg-blue-500 w-52" onClick={() => setOpenAddColSidebar((openAddColSidebar) => !openAddColSidebar)}>Add a collection</button>
                        </div>
                    </div>
                }
